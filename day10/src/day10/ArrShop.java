...
public class ArrShop {
	...
	public static void main(String[] args) {
		...
		int []arASum = new int[2]; //Age adult랑 kids두가지
		int []arBSum = new int[3]; //지점별 Branch
		int sum=0;
		
		double []aAvg = new double[2]; //adult와 kids별 평균
		double []bAvg = new double[3];
		double avg = 0.0;
		
		int rLength =arrIncome.length; //2
		int cLength =arrIncome[0].length; //3
